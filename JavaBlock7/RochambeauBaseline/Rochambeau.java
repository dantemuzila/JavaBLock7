...
public class Rochambeau {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= numberOfRounds; i++) {  // change this 3 to play more or less rounds
		...
		System.out.println(p1.getName() + " scored " + String.valueOf(p1.score));
		System.out.println(p2.getName() + " scored " + String.valueOf(p2.score));
	}
}
